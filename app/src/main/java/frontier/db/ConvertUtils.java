        ...
        TYPE_CONVERSIONS.put(Integer.class, new TypeConvertiable() {
            ...
            public <T> T convertType(
                ...
                case DATABASE:
                    ...
                    // 値の型が Boolean または boolean の場合
                    if (Boolean.class.equals(valueType) || boolean.class.equals(valueType)) {

                        // フラグ形式の値へ変換する
                        return ConvertUtils.<T>cast(
                                value == null ? null : FRDatabaseUtils.toInt((Boolean)value)
                                );
            ...
            public <T> T convertType(
                ...
                case DATABASE:
                    ...
                    if (Boolean.class.equals(valueType) || boolean.class.equals(valueType)) {
                        ...
                        // フラグ形式の値へ変換する
                        return ConvertUtils.<T>cast(
                                FRDatabaseUtils.toInt((Boolean)value)
                                );
        ...
        TYPE_CONVERSIONS.put(Boolean.class, new TypeConvertiable() {
            ...
            public <T> T convertType(
                ...
                case DATABASE:
                    ...
                    // データベース形式で値をBooleanに変換して返す
                    return ConvertUtils.<T>cast(
                            value == null ? null : FRDatabaseUtils.toBoolean(String.valueOf(value))
                            );
        ...
        TYPE_CONVERSIONS.put(boolean.class, new TypeConvertiable() {
            ...
            public <T> T convertType(
                ...
                case DATABASE:
                    ...
                    // データベース形式で値をBooleanに変換して返す
                    return ConvertUtils.<T>cast(
                            FRDatabaseUtils.toBoolean(String.valueOf(value))
                            );
